...
import productRepository from "../persistence/mongoDB/productRepository.js";//Paso a adaptar el mètodo del middleware usando las funciones que gestionan la DB.


//La diferencia con checkProd es que en checkProduct se valida la creación de un producto en cuanto a sus condiciones y parámetros y  en checkProd si existe en la DB.
